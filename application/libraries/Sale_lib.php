...
class Sale_lib
{
	...
	function add_item($item_id,$quantity=0,$discount=0,$price=null,$tax=null)
	{
		...
		array(
			...
			'quantity'=>$this->CI->Item->get_info($item_id)->quantity>$quantity ? $quantity: $this->CI->Item->get_info($item_id)->quantity,
            'discount'=>$discount,
